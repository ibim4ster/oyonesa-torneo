...
export const CATEGORIES: CategoryInfo[] = [
  {
    ...
    pdfUrl: "/2012-Memorial-Gonzalo-Gomez.pdf",
    color: "bg-blue-600",
  ...
  },
  {
    ...
    pdfUrl: "/2013-Memorial-Gonzalo-Gomez.pdf",
  ...
  },
  {
    ...
    pdfUrl: "/2014-Memorial-Gonzalo-Gomez.pdf",
    color: "bg-amber-600",
  ...
  },
  {
    ...
    pdfUrl: "/2015-Memorial-Gonzalo-Gomez.pdf",
    color: "bg-rose-600",
